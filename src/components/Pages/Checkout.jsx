...
const Checkout = ({ checkoutItems }) => {
    ...
    return (
        <div className="h-screen col-start-2 col-span-full">
            <div className="w-full p-10 grid-cols-2 grid ">
                <div className="">
                    ...
                    <form className="p-4 text-black">
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <select id="countries" name="countries" placeholder="country" className="w-full py-2.5 focus:outline-none focus:text-blue-500 border-b-2 border-gray-500 text-sm">
